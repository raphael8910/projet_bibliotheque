...
<html>
<head>
    <title>Prolongation d'un prêt</title>
</head>
<body>
    <h2>Prolongation d'un prêt</h2>
    <form action="/prolongation/${idPret}/{idAdherent}" method="post">
        ...
        <input type="submit" value="Valider la prolongation">
    </form>
