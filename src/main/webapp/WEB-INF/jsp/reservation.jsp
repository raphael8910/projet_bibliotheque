...
<html>
<head>
    <title>Reservation d'un exemplaire</title>
</head>
<body>
    <h2>Reservation d'un exemplaire</h2>
    <form action="/reservation/${session.idBibliothecaire}/{idAdherent}/{idExemplaire}" method="post">
